...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        A2, fc_cache1 = affine_relu_forward(A1, W2, b2)
        scores, fc_cache2 = affine_forward(A2, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dA2, grads['W3'], grads['b3'] = affine_backward(dscores, fc_cache2)
        dA1, grads['W2'], grads['b2'] = affine_relu_backward(dA2, fc_cache1)
